  ...
  Widget _enableToggle() {
    return Container(
      ...
      child: SwitchListTile(
        ...
        onChanged: (v) => setState(() => _settings = _copyWith(enabled: v)),
        activeColor: _accent,
    ...
    return GestureDetector(
      onTap: () async {
        ...
        if (picked != null) {
          ...
          setState(() => _settings = _copyWith(targetWakeTime: t));
        }
      },
      child: Container(
          ...
          children: List.generate(7, (i) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                setState(() => _settings = _copyWith(activeDays: newDays));
              },
              child: Container(
                width: 36, height: 36,
                decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Slider(
          ...
          activeColor: _accent,
          onChanged: (v) => setState(() => _settings = _copyWith(snoozeMinutes: v.round())),
        ),
      ]),
    );
  }
    ...
    return Container(
      ...
      child: Column(children: [
        SwitchListTile(
          ...
          onChanged: (v) => setState(() => _settings = _copyWith(qrWakeEnabled: v)),
  ...
  Widget _nfcWakeToggle() {
    return Container(
      ...
      child: SwitchListTile(
        ...
        onChanged: (v) => setState(() => _settings = _copyWith(nfcWakeEnabled: v)),
