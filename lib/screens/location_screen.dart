...
class _LocationScreenState extends State<LocationScreen>
  ...
  Future<void> _load() async {
    ...
    try {
      _records = await _loc.getTodayLocations();
      _places = _loc.knownPlaces;
      final dateStr = DateFormat('yyyy-MM-dd').format(_selectedDate);
      _timeline = await _loc.getTimelineByDate(dateStr);
      _placeSummary = await _loc.getPlaceSummaryByDate(dateStr);
      ...
      child: Row(children: [
        ...
        Switch(
          ...
          onChanged: (v) async {
            ...
            setState(() => _tracking = _loc.isTracking);
          },
