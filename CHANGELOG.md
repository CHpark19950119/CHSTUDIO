...
### 소설 「허락」 제1부 확장 작업 — 진행 중

> **핸드오프 문서:** `assets/roadmap/HANDOFF_소설_허락_제1부.md`
> **다음 세션에서 반드시 이 파일을 읽고 작업 시작할 것.**

- **시점 변경:** 1인칭 → **전지적 작가 시점 (3인칭)**. 천홍은 인물, 서술자가 판단.
- **목표:** 현재 44,096자 → 100,000자+ (각 챕터 8,000~12,000자)
- **소스 파일:** `assets/허락_전반_01-05.html` + `assets/허락_후반_06-11.html`
- **로드맵 참조:** `assets/roadmap/박천홍_인생로드맵_v13.html`
- **Phase 1:** 전반+후반 HTML 병합 (CSS 후반부 기준 통일, data-chapter 0~10 재배열)
- **Phase 2:** 각 챕터 3인칭으로 방대 확장 (문체 규칙 준수)
- **Phase 3:** 웹앱 배포 → 텔레그램 URL → 허락 후 앱 이식
- **2부 작업:** 1부 완료 + 허락 후 진행

**상태:** Phase 1~2 미착수. 다음 세션에서 시작.
